...
public class ItemController {
    ...
    @Autowired
    OrderBusinessService orderItemService;
    ...
    public ResponseEntity<List<ItemList>> getTopFiveItemsByPopularity(@PathVariable String restaurant_id)
        ...
        for (RestaurantItemEntity r : restaurantItemEntities) {
            OrderItemEntity orderItemEntity = orderItemService.getOrdersByCustomer(r.getItem_quantities());
            idPriceMap.put(orderItemEntity.getItem_quantities(), orderItemEntity.getPrice());
        }
